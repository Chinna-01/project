<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="teamleaderreg.aspx.cs" Inherits="project.teamleaderreg" %>
...
&nbsp;<br />
          <label class="fo">Select Qulification</label>   
           ...
           <asp:CheckBox style="color:white" ID="pg" runat="server" Text="Post Graduation" /><br />
            <asp:Button ID="regi"  runat="server" Text="registration" OnClick="regi_Click"  OnClientClick="return validate()"/><br />
