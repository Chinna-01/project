<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="project.reg" %>
...
&nbsp;&nbsp;&nbsp;
           ...
           <label class="fo"> Confirm password *</label>
            ...
            <Label class="fo" >Select TeamLeader</Label>
            <asp:DropDownList ID="teamleader1" runat="server" ></asp:DropDownList><br />
             <Label class="fo" >Select Manager</Label>
            <asp:DropDownList ID="manager1" runat="server"></asp:DropDownList>
&nbsp;<br />
          <label class="fo">Select Qulification</label>   
           ...
           <asp:CheckBox style="color:white" ID="pg" runat="server" Text="Post Graduation" /><br />
            <br />
            <asp:Button class="button1" ID="Button1" runat="server" Text="Registration" OnClick="Button1_Click" OnClientClick="return validate()" />
            <br />
&nbsp;<br />
            <asp:Label ID="Label1" runat="server" Visible="False" ForeColor="White"></asp:Label>
            <br />
            <br />
            <br />
            <br />
